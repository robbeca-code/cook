let food = [
  {
    ...
    title: '사과 나눔합니다.',
    content: '사과를 선물 받았는데 너무 많이 받게 되어 나눔합니다~ 충주에서 직접 농사지은 맛있는 사과예요.',
    cost: '가격없음',
    location: '사근동',
    author: '바비의 떡볶이',
  ...
  },
  {
    ...
    content: '이사 가야해서 팔아요 참치는 2028년까지구요 스팸은 24년도까지에요 스팸 9개 중 하나는 120그람짜리 작은거에요',
    cost: '10,000',
    location: '사근동',
    author: '이사좋아',
  ...
  },
  {
    ...
    content: '쌀을 너무 많이 받았는데 다 먹지 못하고 5개월간 보관을 잘못했는지 벌레가 생겨 드립합니다.',
    cost: '가격없음',
    location: '성수동',
    author: '꼬똥이',
  ...
  },
  {
    ...
    title: '꿀',
    content: '이번에 여행다녀온 지인이 선물을 줬는데 꿀을 좋아하지 않아 판매합니다. 두병에 만원에 판매할게요.',
    cost: '10,000',
    location: '성수동',
    author: '데일리',
...
let product = [
  ...
  },
  {
    ...
    title: '휘슬러 냄비 4종세트',
    content: '혼수로 구매하고 젤 작은 사이즈만 종종 사용하고 나머지는 각기 열번도 사용 안한 4종세트입니다.',
    cost: '10,000',
    location: '사근동',
    author: 'LoRo',
