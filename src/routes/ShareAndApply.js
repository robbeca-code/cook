...
function ShaApp() {
  return (
    <section className={cn(style.container)}>
      ...
      <article className={cn(style.mainContentContainer)}>
        <header className={cn(style.contentTitle)}>
          <h1>| 나눔 |</h1>
        </header>
        <ul className={cn(style.contentList)}>
      ...
      <article className={cn(style.recommendedUsersContainer)}>
        <header className={cn(style.contentTitle)}>
          <h1>공유 유저 추천</h1>
        </header>
        <ul className={cn(style.contentList)}>
          ...
          <li className={cn(style.item)}>
            ...
            <span className={cn(style.userName)}>초코파이</span>
          </li>
          <li className={cn(style.item)}>
            <div className={cn(style.imgContainer)}>
              <img src="/cook/public-assets/sha_app/non-img.png" alt="" />
